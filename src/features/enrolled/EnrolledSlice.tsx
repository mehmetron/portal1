...
import api, { API_ENROLLED_COURSES } from "../../api";
...
export const fetchAllEnrolled = createAsyncThunk<Board[]>(
    "enrolled/fetchAllStatus",
    async () => {
        const response = await api.get(API_ENROLLED_COURSES);
...
export const slice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchAllEnrolled.pending, (state) => {
            state.fetchLoading = true;
            state.fetchError = null;
            state.detailError = undefined;
        });
        builder.addCase(fetchAllEnrolled.fulfilled, (state, action) => {
            // @ts-ignore
            state.all = action.payload;
            state.fetchError = null;
            state.fetchLoading = false;
        });
        builder.addCase(fetchAllEnrolled.rejected, (state, action) => {
